...
/**
 * POST /api/etiquettes/[id]/unassign — Désaffecte l'étiquette des souvenirs (admin).
...
export async function POST(
  ...
  try {
    await repo.unassign(etiquetteId, souvenir_noms);
    return NextResponse.json({ ok: true });
  } catch (e) {
    console.error('[etiquettes] unassign error:', e);
    return NextResponse.json(
